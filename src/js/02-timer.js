    ...
    if (selectedDate[0] <= new Date()) {
      ...
      function countdownTime() {
        timer = setInterval(() => {
          ...
          d.innerHTML = days < 10 ? addZero(days) : days;
          h.innerHTML = hours < 10 ? addZero(hours) : hours;
          m.innerHTML = minutes < 10 ? addZero(minutes) : minutes;
          s.innerHTML = seconds < 10 ? addZero(seconds) : seconds;
